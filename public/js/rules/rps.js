// Browser-side mirror of netlify/functions/lib/games/rps.js.
const CHOICES = ['rock', 'paper', 'scissors'];
const BEATS = { rock: 'scissors', paper: 'rock', scissors: 'paper' };
const MATCH_TARGET = 3;

export const id = 'rock-paper-scissors';
export const simultaneous = true;
export const ALL_CHOICES = CHOICES;
export const BEATS_MAP = BEATS;
...
export function legalMoves(state, playerIndex) {
  if (state.picks[playerIndex] !== null) return [];
...
export function sanitizeForPlayer(state, playerIndex) {
